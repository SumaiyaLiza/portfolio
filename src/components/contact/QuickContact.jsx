...
const info = [
  { icon: <MdOutlineMail />, name: 'Email', contact: 'lizasumaiya81@gmail.com' },
  { icon: <FaWhatsapp />, name: 'WhatsApp', contact: '+8801892713751' },
];

const openWhatsApp = () => {
  window.open('https://wa.me/+8801892713751', '_blank');
};
